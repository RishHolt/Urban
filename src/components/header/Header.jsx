            ...
            <div className='flex justify-between items-center'>
                ...
                <div className='flex-1 mx-8 max-w-md'>
                    <div className='relative'>
                        ...
                        />
                        <button className='top-1/2 right-2 absolute p-1 text-slate-400 hover:text-slate-600 -translate-y-1/2 transform'>
                ...
                <div className='flex items-center space-x-1'>
                    {/* notification */}
                    <button className='relative hover:bg-slate-200 dark:hover:bg-slate-700 p-2 rounded-xl text-slate-600 dark:hover:text-slate-100 dark:text-slate-400 transition-colors cursor-pointer'>
